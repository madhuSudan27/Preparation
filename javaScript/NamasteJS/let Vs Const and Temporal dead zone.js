...
// we can access b withoud even declearing and initializing it like :-
console.log(b);
// due to hoisting 
...
// we can not use same name in same scope as variable declearation  <- in case of let 

console.log(a);
/* 
    IN CASE OF LET AND CONST <-- MEMORY IS ALLOCATED  so its calledd hoisting 
    ...
    * At line 9 a is in TEMPORAL DEADD ZONE 
